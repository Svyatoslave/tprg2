            ...
            <div class="main-area">
                <div class="content-area">
                    ...
                    <span>
                        ...
                        Помимо этого, для авторизованных как админ-пользователей имеется возможность добавлять/удалять книги, редактировать заказы и аккаунты клиентов.<br><br>
                        Приложение создано для курса "Технологии программирования" в рамках лабораторной работы № 2.<br><br>
                        Над приложением работали: Холодов С.О., Плицын В.А., Варварин Я.Е.<br><br>
			Вы можете связаться с нами по почте kholodovso@oiate.ru
                    </span>
                    </div>
                </div>
            </div>
